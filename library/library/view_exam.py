...
# class BookCustomViewSet(ListModelMixin,DestroyModelMixin,RetrieveAPIView,UpdateAPIView,GenericViewSet):
#     queryset =  Book.objects.all()
#     serializer_class =  BookModelSerializer
#     renderer_classes = [JSONRenderer, BrowsableAPIRenderer]
...
#        return Book.objects.filter(name__contains='Тест')#содержит
# #
#
# class BookListAPIView(ListAPIView):
#    serializer_class = BookModelSerializer
